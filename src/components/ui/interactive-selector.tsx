...
const InteractiveSelector = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-[#222] font-sans text-white w-full"> 
      {/* Header Section */}
      ...
      {/* Options Container */}
      <div className="options flex w-full max-w-[900px] min-w-[300px] md:min-w-[600px] h-[400px] mx-0 items-stretch overflow-hidden relative">

  ...
  return (
    ...
    >
      <div className="mx-auto section-container flex h-full items-center justify-between">
        ...
        <Link
          to="/contact"
          className="hidden lg:inline-flex items-center gap-2 text-sm px-5 py-2 rounded-full bg-accent text-primary font-bold hover:opacity-90 transition-all duration-500 shadow-brand active:scale-95"
        >
          Partner With Us
        </Link>
